...
export class BankBookComponent implements OnInit {
  ...
  getproductDayBook() {
    this.reportService.getBankBook(this.startDate, this.endDate, this.fyID, this.selectData).subscribe((res: any) => {
      console.log(res);
