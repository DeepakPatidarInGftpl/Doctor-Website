...
export class ProductHistoryComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.commonService.validateAndClearDates(this.productHistoryform, this.minDate, this.maxDate);
  ...
  productHistory: any
  getProductHistory() {
    this.reportService.getProductHistory(this.startDate, this.endDate, this.productId, this.fyID, this.selectData).subscribe((res) => {
      console.log(res);
