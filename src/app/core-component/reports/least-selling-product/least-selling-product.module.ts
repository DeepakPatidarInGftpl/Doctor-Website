...
import { LeastSellingProductRoutingModule } from './least-selling-product-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    LeastSellingProductRoutingModule,
    SharedModuleModule,
...
export class LeastSellingProductModule { }
