...
//23    
 this.cs.userDetails$.subscribe((userDetails:any) => {
  ...
  getStockAlert() {
    ...
    this.reportService.getProductLedger(this.startDate, this.endDate, this.category, this.subcategory, this.brand,this.variant,this.fyID,this.selectData).subscribe((res) => {
      console.log(res);
      this.stockAlert = res;
