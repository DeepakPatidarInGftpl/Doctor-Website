...
export class CategoryWisePurchaseComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.commonService.validateAndClearDates(this.categoryWisePurchaseForm, this.minDate, this.maxDate);
  ...
  getCategoryWisePurchase() {
    ...
    this.reportService.getCategoryWisePurchase(this.startDate, this.endDate, this.category, this.fyID, this.selectData).subscribe((res) => {
      console.log(res);
