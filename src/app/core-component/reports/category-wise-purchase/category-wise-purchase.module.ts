...
import { CategoryWisePurchaseRoutingModule } from './category-wise-purchase-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    CategoryWisePurchaseRoutingModule,
    SharedModuleModule,
...
export class CategoryWisePurchaseModule { }
