...
import { DiscountWisePurchaseRoutingModule } from './discount-wise-purchase-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    DiscountWisePurchaseRoutingModule,
    SharedModuleModule,
...
export class DiscountWisePurchaseModule { }
