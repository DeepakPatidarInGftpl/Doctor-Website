...
export class StockMovementComponent implements OnInit {
 ...
 ngOnInit(): void {
  ...
  getPurchaseRegister() {
    this.reportService.getStockMovement(this.startDate, this.endDate,this.fyID,this.selectData).subscribe((res) => {
      console.log(res);
  ...
  generatePDFAgain() {
    ...
    autoTable(doc, {
      head: [
        ['#','Variant','Sku','Product','Opening Balance','Value1','In Qty','Value2','Out Qty','Value3','Closing','Value4']
      ],
