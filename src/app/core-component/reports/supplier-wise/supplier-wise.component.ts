...
@Component({
  ...
  templateUrl: './supplier-wise.component.html',
  styleUrls: ['./supplier-wise.component.scss']
})
export class SupplierWiseComponent implements OnInit {
  ...
  supplierWise: any
  getSupplierWise() {
    this.reportService.getSupplierWise(this.startDate, this.endDate, this.supplierWiseUserId, this.fyID, this.selectData).subscribe((res) => {
      console.log(res);
