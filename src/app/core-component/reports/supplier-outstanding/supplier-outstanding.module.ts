...
import { SupplierOutstandingRoutingModule } from './supplier-outstanding-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    SupplierOutstandingRoutingModule,
    SharedModuleModule,
...
export class SupplierOutstandingModule { }
