...
@Component({
  selector: 'app-tax-wise-sale',
  templateUrl: './tax-wise-sale.component.html',
  styleUrls: ['./tax-wise-sale.component.scss']
})
export class TaxWiseSaleComponent implements OnInit {
  loader = true;
  ...
  getPurchaseRegister() {
    this.reportService.getTaxWiseSale(this.startDate, this.endDate, this.fyID, this.selectData).subscribe((res) => {
      console.log(res);
  ...
  exportToExcel(): void {
    ...
    const fileName = 'taxwisesale.xlsx';
