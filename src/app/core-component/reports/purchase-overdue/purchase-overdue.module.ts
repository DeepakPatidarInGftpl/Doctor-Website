...
import { PurchaseOverdueRoutingModule } from './purchase-overdue-routing.module';
...
@NgModule({
  declarations: [
    PurchaseOverdueComponent
  ],
  imports: [
    CommonModule,
    PurchaseOverdueRoutingModule,
...
export class PurchaseOverdueModule { }
