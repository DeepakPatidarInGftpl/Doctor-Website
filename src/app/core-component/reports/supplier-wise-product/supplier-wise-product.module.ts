...
import { SupplierWiseProductRoutingModule } from './supplier-wise-product-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    SupplierWiseProductRoutingModule,
    SharedModuleModule,
...
export class SupplierWiseProductModule { }
