...
import { TaxWisePurchaseReturnRoutingModule } from './tax-wise-purchase-return-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    TaxWisePurchaseReturnRoutingModule,
    SharedModuleModule,
...
export class TaxWisePurchaseReturnModule { }
