...
export class CustomerWiseSaleOrderComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.commonService.validateAndClearDates(this.customerWiseSaleOrderForm, this.minDate, this.maxDate);
  ...
  getCustomerWiseSaleOrder() {
    this.reportService.getCustomerWiseSaleOrder(this.startDate, this.endDate, this.customerWiseSaleOrderUserId, this.fyID, this.selectData).subscribe((res) => {
      console.log(res);
