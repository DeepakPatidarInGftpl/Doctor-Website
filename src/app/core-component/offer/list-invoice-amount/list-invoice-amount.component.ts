...
@Component({
  ...
  styleUrls: ['./list-invoice-amount.component.scss']
})
export class ListInvoiceAmountComponent implements OnInit {
...
select=false
  ...
  getMembership() {
   ...
   generatePDF() {
    ...
    const doc = new jsPDF();
    const title = 'Invoice Amount Offer';
 ...
 generatePDFAgain() {
  ...
  exportToExcel(): void {
    ...
    const fileName = 'invoice_amount_offer.xlsx';
