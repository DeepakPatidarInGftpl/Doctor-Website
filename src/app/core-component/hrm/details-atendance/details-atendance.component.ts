...
@Component({
  selector: 'app-details-atendance',
  templateUrl: './details-atendance.component.html',
  styleUrls: ['./details-atendance.component.scss']
})
export class DetailsAtendanceComponent implements OnInit {
