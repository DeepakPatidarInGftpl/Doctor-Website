...
@Component({
  selector: 'app-add-address-store',
  templateUrl: './add-address-store.component.html',
  styleUrls: ['./add-address-store.component.scss']
})
export class AddAddressStoreComponent implements OnInit {
