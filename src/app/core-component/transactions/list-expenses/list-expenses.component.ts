...
export class ListExpensesComponent implements OnInit {
  ...
  confirmText(index: any, id: any) {
    Swal.fire({
      ...
      if (t.isConfirmed) {
        this.transactionService.deleteExpensVoucher(id).subscribe(res => {
          this.delRes = res
  ...
  isActive(index: any, id: any) {
    Swal.fire({
      title: 'Are you sure?',
      text: "Do you want to Deactivate this Expense Voucher!",
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
      ...
      if (t.isConfirmed) {
        this.transactionService.ExpensVoucherIsActive(id, '').subscribe(res => {
          this.delRes = res
          if (this.delRes.success) {
            Swal.fire({
              icon: 'success',
  ...
  Active(index: any, id: any) {
    Swal.fire({
      title: 'Are you sure?',
      text: "Do you want to Active this Expense Voucher!",
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
  ...
  ngOnInit(): void {
    this.transactionService.getExpensVoucher().subscribe(res => {
      // console.log(res);
      this.tableData = res;
      this.loader = false;
    ...
    this.cs.userDetails$.subscribe((userDetails) => {
      ...
      permission?.map((res: any) => {
        if (res.content_type.app_label === 'transactions' && res.content_type.model === 'expensesvoucher' && res.codename == 'add_expensesvoucher') {
          this.isAdd = res.codename;
          // console.log(this.isAdd);
        } else if (res.content_type.app_label === 'transactions' && res.content_type.model === 'expensesvoucher' && res.codename == 'change_expensesvoucher') {
          this.isEdit = res.codename;
          // console.log(this.isEdit);
        } else if (res.content_type.app_label === 'transactions' && res.content_type.model === 'expensesvoucher' && res.codename == 'delete_expensesvoucher') {
  ...
  getEstimate(fy:any){
    ...
    this.transactionService.getExpensVoucherFy(fy,this.selectData).subscribe(res => {
      this.tableData = res;
      this.loader = false;
      this.selectedRows = new Array(this.tableData.length).fill(false);
