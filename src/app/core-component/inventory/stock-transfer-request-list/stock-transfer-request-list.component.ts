...
export class StockTransferRequestListComponent implements OnInit {
  ...
  confirmText(index: any, id: any) {
    Swal.fire({
      ...
      if (t.isConfirmed) {
        this.stockService.deleteStockTransferRequest(id).subscribe(res => {
          this.delRes = res
  ...
  isActive(index: any, id: any) {
    Swal.fire({
      ...
      if (t.isConfirmed) {
        this.stockService.StockTransferRequestIsActive(id,'').subscribe(res => {
          this.delRes = res
          if (this.delRes.success) {
            Swal.fire({
              icon: 'success',
...
userDetails:any;
  ngOnInit(): void {
    this.stockService.getStockTransferRequest().subscribe(res => {
      this.tableData = res;
      this.loader=false;
