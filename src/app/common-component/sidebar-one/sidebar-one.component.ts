  ...
  ngOnInit(): void {
    ...
    if (localStorageData && localStorageData.permission) {
      ...
      permission.map((res: any) => {
        ...
        } else if (res.content_type.app_label === 'master' && res.content_type.model === 'warehouse' && res.codename == 'view_warehouse') {
          this.isWarehouse = res.codename
        ...
        //purchase
        else if (res.content_type.app_label === 'master' && res.content_type.model === 'purchaseorder' && res.content_type.model === 'materialinward' && res.content_type.model === 'purchasebill' && res.content_type.model === 'debitnote') {
          this.isPurchaseModule = res.content_type.model
