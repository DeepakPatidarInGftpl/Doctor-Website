...
@Component({
  selector: 'app-special-therapist',
  templateUrl: './special-therapist.component.html',
  styleUrls: ['./special-therapist.component.scss']
})
export class SpecialTherapistComponent {
