...
@Component({
  selector: 'app-gym-fitness-trainer',
  templateUrl: './gym-fitness-trainer.component.html',
  styleUrls: ['./gym-fitness-trainer.component.scss']
})
export class GymFitnessTrainerComponent {
